      ...
      >
        <div className="flex items-start justify-between gap-4 p-5 sm:p-6 border-b border-white/[0.06]">
          <div>
            ...
            {/* Stated up front: leads were dropping out on discovering the
                location only after completing the form. */}
            <p className="inline-flex items-center gap-1.5 mt-3 rounded-full border border-cf-red/30
                          bg-cf-red/[0.08] px-3 py-1.5 text-white text-[11px] sm:text-xs font-semibold">
              <svg className="w-3.5 h-3.5 text-cf-red flex-shrink-0" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
